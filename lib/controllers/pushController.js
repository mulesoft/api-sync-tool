...
module.exports = function (apiPlatformService, errors, localService, logger,
  ...
  function push() {
    ...
    return BPromise.props({
      ...
      localStatus: localService.status(),
      directories: localService.getDirectoriesPath(),
      conflicts: localService.conflicts()
    })
    ...
    .then(function (filesMetadata) {
      ...
      var newDirectoriesPath = getNewDirectoriesPath(directories);
