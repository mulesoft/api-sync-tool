...
module.exports = function () {
  return {
    ...
    rootRamlPathPromptMessage: function () {
      return 'Select the path of the root RAML file';
    },
    createAPIPromptMessage: function () {
      return 'Do you want to add a new:';
    },
    repeatedAPINameMessage: function () {
      return 'The name is already in use';
    },
    repeatedAPIVersionNameMessage: function () {
      return 'The version name is already in use';
    },
